...
| `skills/review/references/review-rounds.md` | Chín vòng review và mỗi vòng mở ra cái gì trước, vòng nào chạy nhiều bản và vòng nào chạy một lượt, cách agent gọi phát trước một vòng khi điều phối mà không cho vòng nào thấy kết quả của vòng khác, và cách gộp phát hiện của một vòng thành một danh sách xếp hạng |
